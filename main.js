...
const getWeatherData = async (coord) => {
  ...
  console.log(data);
  const date = new Date();
  console.log(`Updated as of: ${(0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(date, 'h:mmbbb')}`);
  console.log((0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(date, 1), 'ccc LLL d'));
};
