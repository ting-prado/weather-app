...
const displayData = (() => {
  ...
  const current = (weather) => {
    ...
    currentTime.textContent = `${(0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(date, 'h:mm bbb')}`;
  ...
  const daily = (weather) => {
    for (let i = 0; i < weather.daily.length; i++) {
      cards[i].children[0].textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(
        (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(date, i + 1),
        'ccc LLL d'
      );
