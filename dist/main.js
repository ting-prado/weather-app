...
const displayData = (weather) => {
  ...
  currentTime.textContent = `Updated as of: ${(0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(), 'h:mmbbb')}`;
